...
import { ShieldCheck, ArrowLeft, Shield, Mail, Lock } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#0A101D] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-[420px] rounded-3xl shadow-2xl border border-white/10 overflow-hidden backdrop-blur-xl bg-white/5 p-10">
                ...
                <div className="flex flex-col items-center justify-center mb-10 text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-500/20 border border-white/10">
                        <Shield className="w-8 h-8 text-white" />
                    </div>
                    <h2 className="text-[28px] font-bold text-white tracking-tight mb-2">Super Admin Portal</h2>
                    <p className="text-white/40 text-[14px]">Secure access for administration</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full py-4 rounded-xl font-bold text-white text-md bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 transition-all flex items-center justify-center gap-2 mt-6 disabled:opacity-70 shadow-lg shadow-blue-500/25"
                    >
                        {isLoading ? (
