...
const AdminDashboard = () => {
    ...
    // Debounce or helper to fetch logs on filter change could be added, 
                ...
                <div className="bg-white dark:bg-slate-800 rounded-[32px] p-8 shadow-sm border border-gray-100 dark:border-slate-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        <input
                            ...
                            className="p-3 rounded-xl bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <select
                            name="entity"
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-slate-700">
                                {logs.map((log, index) => (
                                    <tr key={log._id} className="group hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                                        ...
                                        <td className="py-3 px-4">
                                            <span className={`px-2 py-1 rounded text-xs font-bold uppercase ${log.role === 'admin' ? 'bg-purple-50 text-purple-600' : 'bg-blue-50 text-blue-600'}`}>
                                                {log.role}
                                            </span>
                                        </td>
